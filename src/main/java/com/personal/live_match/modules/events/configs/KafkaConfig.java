...
public class KafkaConfig {
    ...
    @Bean
    @NonNull
    public ProducerFactory<String, MatchEventMessage> matchEventProducer() {
    ...
    @Bean
    public KafkaTemplate<String, MatchEventMessage> kafkaTemplate() {
        return new KafkaTemplate<>(matchEventProducer());
    }
}
